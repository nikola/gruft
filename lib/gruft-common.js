/*!
 *  gruft-common module Version 0.0.8-2009xxyy 
 *  Copyright 2005-2009, Nikola Klaric
 *
 ...
 * 
 * TODO: rewrite for loops as ++counter instead of counter++
 */
 ...
 * ...
 */
gruft.common || new function (scope) {
	...
	var _is = new function (proto, that) {
         ...
         *  function(s,u){
         *      return function(o) {
         *          return o == u ? "" + o : s.call(o).slice(8,-1)
         *      }
         * })
         * ({}.toString
         * );
    ...
    var _reflect = function (context, implementation) {
        ...
        if (!(id in _dict("MD5", "SHA1", "SHA256", "TIGER192", "AES256"))) {
            ...
            if (!_singletons[id]) {
                ...
                if ("__init__" in _singletons[id]) {
                    _singletons[id].__init__.call(_singletons[id]);
                }
    ...
    /**
     * ...
     * TODO: http://blog.stevenlevithan.com/archives/fast-string-multiply
