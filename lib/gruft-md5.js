...
/**
 * Factory functor for producing safe instances.
 */
gruft.MD5 = function () {
...
gruft.__MD5__ = function() { }; gruft.__MD5__.prototype = {
    ...
    // TODO: rename __name__ to __type__ and __repr__ to __name__
    __name__   : "gruft.MD5",
    __repr__   : "MD5",
    ...
    __digest__: function (message) {
        var bits = message.length << 3, chunks = 16 + ((bits + 64 >>> 9) << 4) - 1, padded = 16 + chunks - 1,
