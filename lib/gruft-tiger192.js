/**
 *  gruft-tiger192 module Version 0.0.8-2007xxyy Copyright (c) 2007 Nikola Klaric.
 *
 ...
 *
 */
gruft.__TIGER192__ = function () {
    if (this instanceof gruft.__TIGER192__) {
 ...
 *
 */
gruft.__TIGER192__.prototype = {

    __name__    : "gruft.TIGER192",
    __repr__    : "TIGER/192",    
    ...
    /**
     * Compress message to TIGER/192 digest in pure Javascript.
     * 
     * @param {String} message The string to compress. 
     * @param {Object} options Destination format options.
     * @return {Array} TIGER/192 digest as a 6-tuple of 32-bit words. 
     */
    __digest__: function (message, options) {
        ...
        while (++z < zeros) { padding.push(sfc(0)); }
