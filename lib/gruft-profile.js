/*!
 *  gruft-profile module Version 0.0.8-2007xxyy Copyright (c) 2007 Nikola Klaric.
 *
...
gruft.dummy = function (global) {
    ...
    var DELAY = 0;
    var DIAGRAM_CANVAS_HEIGHT = 100;
    var SCALE_RATE = 7500, SCALE_TIME = 600;
    ...
    var _build = function (parent) {
        ...
        var widgetWidth = 900, widgetHeight = 256, widgetPadding = 4;
    ...
    var _update = function (){
        ...
        document.getElementById("progress-bar").style.width = Math.round((counter + 1) / 400 * 86) + "px";
        var p = (Math.round((counter + 1) / 400 * 100 * 10) / 10).toString();
        if (p.indexOf(".") == -1) 
            p += ".0";
        document.getElementById("progress-text").innerHTML = p + "%";
