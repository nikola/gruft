 ...
 */
gruft.SHA1 = function () {
    if (typeof gruft.common === typeof gruft && typeof gruft.common.reflect === typeof gruft.SHA1) {
...
/**
 * Implementation of SHA-1 digest function.
 */
gruft.__SHA1__ = function () { }; gruft.__SHA1__.prototype = {
    ...
    selftest: function () {
        if (typeof this.__digest__ !== typeof this.selftest) {
            throw gruft.IntegrityError("<%s.__digest__> is not callable", this.__module__, "gruft-sha1.js");
        }
        ...
        var digest = this.__digest__, gc = gruft.common, error = "SHA-1 digest of test vector %s is erroneous",
            ...
            failUnlessEqual = gc.bind(gc.failUnlessEqual, gc, "gruft-sha1.js");
    ...
    /**
     * Compress message to SHA-1 digest.
     * 
     * @param {String} message 
     *          The string to compress. 
     *          
     * @return {Array} 
     *          SHA-1 digest as a 5-tuple of 32-bit words.
     */
    __digest__: function (message) {
        ...
        var a = 0x67452301, b = 0xefcdab89, c = 0x98badcfe, d = 0x10325476, e = 0xc3d2e1f0, f, g, 
